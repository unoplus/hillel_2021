...
Скрипт сортирует сгенерированный список, в сортированном списке устанавливает
диапазон из которго будет, случайным образом, выбираться число, которое будет
являтся высотой фигуры, которые, затем будут выведены на экран.
"""
import random
