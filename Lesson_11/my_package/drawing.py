...
Фигуры выводятся при помощи символов '*' и ' ', построчно. Вывести можно следующие фигуры:
...
def rhombus_line(high: int):
    """
    Функция выводит на экран ромб заполненый на половину с вертикальной полосой в центре.
    :param high: Параметр высоты фигуры
    :return: Вывод фигуры на экран
    """
    for i in range(high - 1, -1, -1):
