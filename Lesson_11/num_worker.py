...
Скрипт сортирует сгенерированный список, сортированный список будет сконвертирован в число,
с той же последовательностью элементов, которое затем будет развёрнуто задом на перёд и выведено на экран.
"""
...
def list_to_num(some_list: list) -> int:
    """
    Функция служит для конвертирования списка в число с той же последовательностью элементов
    и вызова функции для разворота полученного числа
