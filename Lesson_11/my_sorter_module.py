# Create by Bender
"""
Данный модуль выполняет сортировку последовательностей (список) при помощи двух разных алгоритмов.
...
def partition(nums, low, high):
    """
    Функция определения среднего элемента последовательности, в качестве опорного.
    :param nums: Принимает несортированный список
...
def quick_sort(nums: list) -> list:
    ...
    def _quick_sort(items: list, low: int, high: int) -> None:
        """
        Вспомогательная функция, которая вызывается рекурсивно, служит для получения опорного элемента
